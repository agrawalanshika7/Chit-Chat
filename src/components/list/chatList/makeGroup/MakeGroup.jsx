...
const MakeGroup = (props) => {
    ...
    const handleMake = async(e) => {
        ...
        try {
            ...
            toast.success("Group created! You can chat now!");
            });
        } catch (err) {
            console.log(err);
        }
                ...
                <div>
                    <div className="membersContainer">
                        ...
                        <select name="userSearch" id="userSearch">
                            {chats?.map(chat => (
                                <option key={chat.user.id} value={chat.user.id}>
                                    {chat.user.username}
                                </option>
                            ))}
                        </select>
                    ...
                    <div className="usersContainer">
                        {users.map(({ user }) => (
                            <div key={user.id} className="users">
                                ...
                                <p>{user.username}</p>
                                <img src="/close.png" alt="close" className="removeMember" onClick={() => handleRemove(user.id)} />
                            </div>
                        ))}
                    </div>
                </div>
